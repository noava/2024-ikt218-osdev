// File from teacher as part of the assignment files we recieved. https://perara.notion.site/IKT218-Advanced-Operating-Systems-2024-bfa639380abd46389b5d69dcffda597a?p=83eabc342fd24b88b00733a78b5a86e0&pm=s
#ifndef SONG_H
#define SONG_H
#include "stdio.h"
...
static Note charge_theme[] = {
    {As4, 400}, {F4, 400}, {G4, 400}, {A4, 400},
    {As4, 300}, {F4, 300}, {G4, 300}, {A4, 300},
    {B4, 250}, {Fs4, 250}, {Gs4, 250}, {As4, 250},
    {B4, 250}, {Fs4, 250}, {Gs4, 250}, {As4, 250},
    {C5, 250}, {G4, 250}, {A4, 250}, {B4, 250},
    {C5, 250}, {G4, 250}, {A4, 250}, {B4, 250}, {C5, 750},
    {G4, 150}, {C5, 150}, {E5, 150}, {G5, 250}, {E5, 150}, {G5, 750}
};
